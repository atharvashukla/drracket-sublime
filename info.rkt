  ...
  `(#hash((name . "Monokai")
          (colors
           ...
           ((framework:basic-canvas-background                 ,backg)
            ...
            (framework:paren-match-color                       ,foreg)
            ...
            (framework:syntax-color:scheme:hash-colon-keyword  ,red)
            (framework:syntax-color:scheme:keyword             ,foreg)
            (framework:syntax-color:scheme:string              ,yellow)
            (framework:syntax-color:scheme:other               ,green)
            (framework:syntax-color:scheme:parenthesis         ,foreg)
            (framework:syntax-color:scheme:symbol              ,foreg)
            (drracket:read-eval-print-loop:error-color         ,foreg)
            ...
            (drracket:check-syntax:free-variable               ,foreg)
            (drracket:check-syntax:imported                    ,foreg)
            (drracket:check-syntax:lexically-bound             ,foreg)
            ...
            (drracket:check-syntax:unused-require              ,foreg))))))
